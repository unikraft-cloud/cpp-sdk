...
Create_instance_request_service_group_domains_inner::Create_instance_request_service_group_domains_inner()
{
...
void Create_instance_request_service_group_domains_inner::validate()
{
    // TODO: implement validation
}

web::json::value Create_instance_request_service_group_domains_inner::toJson() const
{
...
bool Create_instance_request_service_group_domains_inner::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("certificate"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<Certificate> refVal_setCertificate;
...
void Create_instance_request_service_group_domains_inner::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Create_instance_request_service_group_domains_inner::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t Create_instance_request_service_group_domains_inner::getFqdn() const
{
    return m_Fqdn;
}

void Create_instance_request_service_group_domains_inner::setFqdn(const utility::string_t& value)
{
    m_Fqdn = value;
    m_FqdnIsSet = true;
}

bool Create_instance_request_service_group_domains_inner::fqdnIsSet() const
{
    return m_FqdnIsSet;
}

void Create_instance_request_service_group_domains_inner::unsetFqdn()
{
    m_FqdnIsSet = false;
}
std::shared_ptr<Certificate> Create_instance_request_service_group_domains_inner::getCertificate() const
{
    return m_Certificate;
}

void Create_instance_request_service_group_domains_inner::setCertificate(const std::shared_ptr<Certificate>& value)
{
    m_Certificate = value;
    m_CertificateIsSet = true;
}

bool Create_instance_request_service_group_domains_inner::certificateIsSet() const
{
    return m_CertificateIsSet;
}

void Create_instance_request_service_group_domains_inner::unsetCertificate()
{
    m_CertificateIsSet = false;
}
}
